...
if (!Object.getOwnPropertyDescriptor(Module, "handleFSError")) Module["handleFSError"] = function() { abort("'handleFSError' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
